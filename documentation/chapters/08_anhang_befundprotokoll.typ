// Anhang: Befundprotokoll der Machbarkeitsstudie.
// Von einem KI-System erstellt und inhaltlich unverändert übernommen. Folgt
// bewusst nicht den Stilregeln der übrigen Dokumentation, nicht umschreiben.
...
den technischen Fragen aus @varianten und @machbarkeitsbeurteilung. Es wurde von
einem KI-System erstellt und ist inhaltlich unverändert übernommen, angepasst
wurden nur Rechtschreibung und Gliederung. Das Protokoll behält seine
ursprüngliche Nummerierung ab 0, auf die sich die Verweise darin beziehen. Wo das Protokoll von
der Entwicklungsumgebung oder der D365-Entwicklungsumgebung spricht, ist die
Testumgebung des Arbeitgebers gemeint, auf der nur ausgeführt und beobachtet
wurde.
...
// Die Unterabschnitte tragen die Nummern der ursprünglichen Fassung (ab 0) und
// erscheinen weder im Inhaltsverzeichnis noch in den PDF-Lesezeichen. Die
// Set-Regel gilt nur innerhalb dieser Datei.
#set heading(
  outlined: false,
  bookmarked: false,
  numbering: (..n) => {
